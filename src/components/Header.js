...
export  function Header(){
  ...
  const activeLink = "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
  const inActiveLink = "block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
  return (
    <header>
      <nav className="bg-white sticky border-b-2 border-gray-200 dark:bg-gray-900 dark:border-gray-400">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div id="mobile-device" className="flex md:order-2">
            <button onClick={()=>{setDarkMode(!darkMode)}} className="mr-2 w-6 h-6 self-center border-2 bg-white">
          ...
          <div id="nav-links" className={`${hidden?"hidden":""} items-center justify-between  w-full md:flex md:w-auto md:order-1`}>
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <NavLink to="/" className={({isActive})=>isActive?activeLink:inActiveLink} end>Home</NavLink>
              </li>
              <li>
                <NavLink to="/popular" className={({isActive})=>isActive?activeLink:inActiveLink}>Popular</NavLink>
              </li>
              <li>
                <NavLink to="/top-rated" className={({isActive})=>isActive?activeLink:inActiveLink}>Top Rated</NavLink>
              </li>
              <li>
                <NavLink to="/upcoming" className={({isActive})=>isActive?activeLink:inActiveLink}>Upcoming</NavLink>
              </li>
            </ul>
          </div>
        </div>
